...
<div class="mt-16">
  <form class="flex flex-col gap-8" @submit.prevent="handleSubmit">
    <label for="name" class="text-lg font-medium text-gray-800">Nome
      <input
        id="name"
        name="name"
        type="text"
...
export default {
  ...
  setup() {
    ...
    const errorToastMessage = {
      400: 'Ocorreu um erro ao criar a conta',
      500: 'Ops... Aconteceu um erro inesperado',
    }

    const { value: nameValue, errorMessage: nameErrorMessage } = useField('email', validateEmptyAndLength3)
